  ...
  <div>
       ...
       <div class="container">
           ...
           <div class="row mb-2">
               ...
               <div class="col-md-6" v-for= "(blog,index) in blogs" :key= "index">
                   <div
                       class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                       <div class="col p-4 d-flex flex-column position-static">
                           ...
                           <p class="mb-auto">{{blog.title}}</p>
                        

                               <button class="btn btn-success" @click="viewBlog(blog.id)">
                                   Continue reading
                               </button>
...
export default {
    ...
    methods:{
     async  getBlogs(){
        ...
        this.blogs = res.data.splice(0,5)
        },
          viewBlog(id){
